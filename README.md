...
**Версия 0.3.1 — экспериментальная сборка с диагностикой автоматики и QR-сопряжением.** Логика автоматики реализована, но совместимость физического подключения зависит от Android и наушников. Новые локальные сборки находятся в `dist`; список проверок — в [validation 0.3.1](docs/validation-0.3.1.md).
...
- Фильтр приложений, задержка 2–5 секунд, пауза между передачами 5–60 секунд, настраиваемый приоритет ручной команды (по умолчанию 15 секунд).
...
Для версии 0.3.1 обнови оба приложения. Дубли в списках удаляются по Bluetooth-адресу. При несовпадении наушников сравни адреса в разделе «Устройства»: совпадения имени недостаточно. Android может выбрать точное совпадение кнопкой «Выбрать наушники как на Mac».
