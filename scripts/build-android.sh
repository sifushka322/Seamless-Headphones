...
mkdir -p dist
cp android/app/build/outputs/apk/debug/app-debug.apk dist/SeamlessHeadphones-0.2-android.apk
echo "Built: $ROOT/dist/SeamlessHeadphones-0.2-android.apk (debug signing)"
