...
mkdir -p dist
cp android/app/build/outputs/apk/debug/app-debug.apk dist/SeamlessHeadphones-0.5.0-android.apk
echo "Built: $ROOT/dist/SeamlessHeadphones-0.5.0-android.apk (debug signing)"
